...
# [Retail: Node.js Samples](https://github.com/googleapis/nodejs-retail)
...
View the [source code](https://github.com/googleapis/nodejs-retail/blob/master/samples/quickstart.js).
