...
describe('v2beta.ServingConfigServiceClient', () => {
  describe('Common methods', () => {
    it('has servicePath', () => {
      const servicePath =
        servingconfigserviceModule.v2beta.ServingConfigServiceClient
          .servicePath;
      assert(servicePath);
    });
    ...
    it('has port', () => {
      const port =
        servingconfigserviceModule.v2beta.ServingConfigServiceClient.port;
      assert(port);
    ...
    it('invokes createServingConfig without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createServingConfig(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.retail.v2beta.IServingConfig | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listServingConfigs', () => {
    ...
    it('invokes listServingConfigsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.retail.v2beta.ServingConfig) => {
