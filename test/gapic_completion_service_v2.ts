...
describe('v2.CompletionServiceClient', () => {
  describe('Common methods', () => {
    it('has servicePath', () => {
      const servicePath =
        completionserviceModule.v2.CompletionServiceClient.servicePath;
      assert(servicePath);
    });

    it('has apiEndpoint', () => {
      const apiEndpoint =
        completionserviceModule.v2.CompletionServiceClient.apiEndpoint;
      assert(apiEndpoint);
    });
    ...
    it('invokes completeQuery without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.completeQuery(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.retail.v2.ICompleteQueryResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
