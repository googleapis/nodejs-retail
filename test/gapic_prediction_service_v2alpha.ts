...
describe('v2alpha.PredictionServiceClient', () => {
  describe('Common methods', () => {
    it('has servicePath', () => {
      const servicePath =
        predictionserviceModule.v2alpha.PredictionServiceClient.servicePath;
      assert(servicePath);
    });

    it('has apiEndpoint', () => {
      const apiEndpoint =
        predictionserviceModule.v2alpha.PredictionServiceClient.apiEndpoint;
      assert(apiEndpoint);
    });
    ...
    it('invokes predict without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.predict(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.retail.v2alpha.IPredictResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
