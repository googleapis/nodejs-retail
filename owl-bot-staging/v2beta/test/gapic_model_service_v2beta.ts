...
describe('v2beta.ModelServiceClient', () => {
    ...
    describe('pauseModel', () => {
        it('invokes pauseModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.PauseModelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.retail.v2beta.Model()
            );
    ...
    describe('resumeModel', () => {
        it('invokes resumeModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.ResumeModelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.retail.v2beta.Model()
    ...
    describe('deleteModel', () => {
        it('invokes deleteModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.DeleteModelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('updateModel', () => {
        it('invokes updateModel without error', async () => {
            ...
            request.model ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.UpdateModelRequest', ['model', 'name']);
    ...
    describe('createModel', () => {
        it('invokes createModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.CreateModelRequest', ['parent']);
    ...
    describe('tuneModel', () => {
        it('invokes tuneModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.TuneModelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listModels', () => {
        it('invokes listModels without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.ListModelsRequest', ['parent']);
            request.parent = defaultValue1;
