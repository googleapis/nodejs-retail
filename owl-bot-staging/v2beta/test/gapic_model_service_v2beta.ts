...
describe('v2beta.ModelServiceClient', () => {
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = modelserviceModule.v2beta.ModelServiceClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = modelserviceModule.v2beta.ModelServiceClient.apiEndpoint;
            assert(apiEndpoint);
        });

        it('has port', () => {
            const port = modelserviceModule.v2beta.ModelServiceClient.port;
            assert(port);
            assert(typeof port === 'number');
        });

        it('should create a client with no option', () => {
            const client = new modelserviceModule.v2beta.ModelServiceClient();
            assert(client);
        });
    ...
    describe('pauseModel', () => {
        it('invokes pauseModel without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.retail.v2beta.Model());
            client.innerApiCalls.pauseModel = stubSimpleCall(expectedResponse);
            const [response] = await client.pauseModel(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.pauseModel as SinonStub)
        ...
        it('invokes pauseModel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.pauseModel(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2beta.IModel|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('resumeModel', () => {
        it('invokes resumeModel without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2beta.ResumeModelRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.resumeModel as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('deleteModel', () => {
        it('invokes deleteModel without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2beta.DeleteModelRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('updateModel', () => {
        it('invokes updateModel without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2beta.UpdateModelRequest());
            request.model = {};
            request.model.name = '';
    ...
    describe('createModel', () => {
        it('invokes createModel without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2beta.CreateModelRequest());
            request.parent = '';
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createModel as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes createModel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createModel(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.retail.v2beta.IModel, protos.google.cloud.retail.v2beta.ICreateModelMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.retail.v2beta.IModel, protos.google.cloud.retail.v2beta.ICreateModelMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createModel as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
    ...
    describe('tuneModel', () => {
        it('invokes tuneModel without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2beta.TuneModelRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.tuneModel as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes tuneModel without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.tuneModel(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.retail.v2beta.ITuneModelResponse, protos.google.cloud.retail.v2beta.ITuneModelMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.retail.v2beta.ITuneModelResponse, protos.google.cloud.retail.v2beta.ITuneModelMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.tuneModel as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
    ...
    describe('listModels', () => {
        it('invokes listModels without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2beta.ListModelsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.retail.v2beta.Model()),
              generateSampleMessage(new protos.google.cloud.retail.v2beta.Model()),
              generateSampleMessage(new protos.google.cloud.retail.v2beta.Model()),
            ];
        ...
        it('invokes listModelsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.retail.v2beta.Model[] = [];
                stream.on('data', (response: protos.google.cloud.retail.v2beta.Model) => {
        ...
        it('uses async iteration with listModels without error', async () => {
            ...
            const responses: protos.google.cloud.retail.v2beta.IModel[] = [];
