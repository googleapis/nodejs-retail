...
describe('v2beta.ModelServiceClient', () => {
    ...
    describe('pauseModel', () => {
        it('invokes pauseModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('PauseModelRequest', ['name']);
    ...
    describe('resumeModel', () => {
        it('invokes resumeModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ResumeModelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.retail.v2beta.Model()
    ...
    describe('deleteModel', () => {
        it('invokes deleteModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteModelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('updateModel', () => {
        it('invokes updateModel without error', async () => {
            ...
            request.model ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateModelRequest', ['model', 'name']);
    ...
    describe('createModel', () => {
        it('invokes createModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateModelRequest', ['parent']);
    ...
    describe('tuneModel', () => {
        it('invokes tuneModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('TuneModelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listModels', () => {
        it('invokes listModels without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListModelsRequest', ['parent']);
            request.parent = defaultValue1;
