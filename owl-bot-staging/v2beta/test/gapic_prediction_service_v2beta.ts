...
describe('v2beta.PredictionServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = predictionserviceModule.v2beta.PredictionServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = predictionserviceModule.v2beta.PredictionServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });
    ...
    describe('predict', () => {
        it('invokes predict without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2beta.PredictRequest());
            request.placement = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.retail.v2beta.PredictResponse());
        ...
        it('invokes predict without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.predict(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2beta.IPredictResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
