...
describe('v2beta.CatalogServiceClient', () => {
    ...
    describe('updateCatalog', () => {
        it('invokes updateCatalog without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2beta.UpdateCatalogRequest());
            request.catalog = {};
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.retail.v2beta.Catalog());
    ...
    describe('setDefaultBranch', () => {
        it('invokes setDefaultBranch without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2beta.SetDefaultBranchRequest());
            request.catalog = '';
    ...
    describe('getDefaultBranch', () => {
        it('invokes getDefaultBranch without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2beta.GetDefaultBranchRequest());
            request.catalog = '';
            const expectedHeaderRequestParams = "catalog=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.retail.v2beta.GetDefaultBranchResponse());
    ...
    describe('getCompletionConfig', () => {
        it('invokes getCompletionConfig without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2beta.GetCompletionConfigRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.retail.v2beta.CompletionConfig());
    ...
    describe('updateCompletionConfig', () => {
        it('invokes updateCompletionConfig without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2beta.UpdateCompletionConfigRequest());
    ...
    describe('getAttributesConfig', () => {
        it('invokes getAttributesConfig without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.retail.v2beta.AttributesConfig());
    ...
    describe('addCatalogAttribute', () => {
        it('invokes addCatalogAttribute without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2beta.AddCatalogAttributeRequest());
            request.attributesConfig = '';
    ...
    describe('removeCatalogAttribute', () => {
        it('invokes removeCatalogAttribute without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2beta.RemoveCatalogAttributeRequest());
            request.attributesConfig = '';
            const expectedHeaderRequestParams = "attributes_config=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('batchRemoveCatalogAttributes', () => {
        it('invokes batchRemoveCatalogAttributes without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2beta.BatchRemoveCatalogAttributesRequest());
            request.attributesConfig = '';
            const expectedHeaderRequestParams = "attributes_config=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.retail.v2beta.BatchRemoveCatalogAttributesResponse());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.batchRemoveCatalogAttributes as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('replaceCatalogAttribute', () => {
        it('invokes replaceCatalogAttribute without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2beta.ReplaceCatalogAttributeRequest());
            request.attributesConfig = '';
            const expectedHeaderRequestParams = "attributes_config=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listCatalogs', () => {
        it('invokes listCatalogs without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2beta.ListCatalogsRequest());
            request.parent = '';
