...
describe('v2beta.ControlServiceClient', () => {
    ...
    describe('createControl', () => {
        it('invokes createControl without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.CreateControlRequest', ['parent']);
    ...
    describe('deleteControl', () => {
        it('invokes deleteControl without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.DeleteControlRequest', ['name']);
    ...
    describe('updateControl', () => {
        it('invokes updateControl without error', async () => {
            ...
            request.control ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.UpdateControlRequest', ['control', 'name']);
    ...
    describe('getControl', () => {
        it('invokes getControl without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.GetControlRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.retail.v2beta.Control()
    ...
    describe('listControls', () => {
        it('invokes listControls without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2beta.ListControlsRequest', ['parent']);
            request.parent = defaultValue1;
