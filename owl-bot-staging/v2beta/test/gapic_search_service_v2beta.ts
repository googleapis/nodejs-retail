...
describe('v2beta.SearchServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = searchserviceModule.v2beta.SearchServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = searchserviceModule.v2beta.SearchServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });
    ...
    describe('search', () => {
        it('invokes search without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2beta.SearchRequest());
            request.placement = '';
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.retail.v2beta.SearchResponse.SearchResult()),
              generateSampleMessage(new protos.google.cloud.retail.v2beta.SearchResponse.SearchResult()),
              generateSampleMessage(new protos.google.cloud.retail.v2beta.SearchResponse.SearchResult()),
            ];
        ...
        it('invokes search without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.search(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2beta.SearchResponse.ISearchResult[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes searchStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.retail.v2beta.SearchResponse.SearchResult) => {
