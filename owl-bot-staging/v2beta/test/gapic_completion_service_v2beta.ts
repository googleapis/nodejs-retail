...
describe('v2beta.CompletionServiceClient', () => {
    ...
    describe('completeQuery', () => {
        it('invokes completeQuery without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2beta.CompleteQueryRequest());
            request.catalog = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.retail.v2beta.CompleteQueryResponse());
    ...
    describe('importCompletionData', () => {
        it('invokes importCompletionData without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2beta.ImportCompletionDataRequest());
            request.parent = '';
