 ...
 *   {@link google.cloud.retail.v2beta.SearchRequest.filter|filter} and
 *   {@link google.cloud.retail.v2beta.SearchRequest.page_categories|page_categories}.
 ...
 *   A page token
 *   {@link google.cloud.retail.v2beta.SearchResponse.next_page_token|SearchResponse.next_page_token},
 ...
 *   result location, amongst the {@link google.cloud.retail.v2beta.Product|Product}s
 *   deemed by the API as relevant) in search results. This field is only
 *   considered if
 *   {@link google.cloud.retail.v2beta.SearchRequest.page_token|page_token} is unset.
 *
 *   If this field is negative, an INVALID_ARGUMENT is returned.
 ...
 *   {@link google.cloud.retail.v2beta.SearchRequest.canonical_filter|SearchRequest.canonical_filter}
 *   will be returned as a supplement of the original query. This field is
 *   strongly recommended to achieve high search quality.
 *
 *   See {@link google.cloud.retail.v2beta.SearchRequest.filter|SearchRequest.filter}
 ...
 *   and
 *   {@link google.cloud.retail.v2beta.SearchRequest.boost_spec|SearchRequest.boost_spec}
 ...
 *   {@link google.cloud.retail.v2beta.LocalInventory|LocalInventory}s attributes.
 *   The attributes from all the matching
 *   {@link google.cloud.retail.v2beta.Product.Type.VARIANT|variant}
 *   {@link google.cloud.retail.v2beta.Product|Product}s or
 *   {@link google.cloud.retail.v2beta.LocalInventory|LocalInventory}s are merged and
 ...
 *     {@link google.cloud.retail.v2beta.LocalInventory.attributes|Product.local_inventories.attributes}
 *     map.
 *   * attributes.key, where key is any key in the
 *     {@link google.cloud.retail.v2beta.Product.attributes|Product.attributes} map.
 *   * pickupInStore.id, where id is any
 *   {@link google.cloud.retail.v2beta.FulfillmentInfo.place_ids|FulfillmentInfo.place_ids}
 *   for {@link google.cloud.retail.v2beta.FulfillmentInfo.type|FulfillmentInfo.type}
 *     "pickup-in-store".
 ...
 *   The first element of the array is Array of [SearchResult]{@link google.cloud.retail.v2beta.SearchResponse.SearchResult}.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing [SearchResult]{@link google.cloud.retail.v2beta.SearchResponse.SearchResult} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   [SearchResult]{@link google.cloud.retail.v2beta.SearchResponse.SearchResult}. The API will be called under the hood as needed, once per the page,
