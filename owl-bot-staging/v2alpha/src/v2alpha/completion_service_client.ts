...
import {Callback, CallOptions, Descriptors, ClientOptions, GrpcClientOptions, LROperation, LocationsClient, LocationProtos} from 'google-gax';
...
export class CompletionServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    const importCompletionDataResponse = protoFilesRoot.lookup(
      '.google.cloud.retail.v2alpha.ImportCompletionDataResponse') as gax.protobuf.Type;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.retail.v2alpha.CompletionService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.completionServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.retail.v2alpha.CompletionService') :
 ...
 */
  completeQuery(
      ...
      Promise<[
        ...
        protos.google.cloud.retail.v2alpha.ICompleteQueryRequest|undefined, {}|undefined
      ]>;
  completeQuery(
      request: protos.google.cloud.retail.v2alpha.ICompleteQueryRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.retail.v2alpha.ICompleteQueryResponse,
          protos.google.cloud.retail.v2alpha.ICompleteQueryRequest|null|undefined,
          {}|null|undefined>): void;
  completeQuery(
      request: protos.google.cloud.retail.v2alpha.ICompleteQueryRequest,
      callback: Callback<
 ...
 */
  importCompletionData(
      ...
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.retail.v2alpha.IImportCompletionDataResponse, protos.google.cloud.retail.v2alpha.IImportMetadata>,
 ...
 */
  async checkImportCompletionDataProgress(name: string): Promise<LROperation<protos.google.cloud.retail.v2alpha.ImportCompletionDataResponse, protos.google.cloud.retail.v2alpha.ImportMetadata>>{
    ...
    const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.importCompletionData, this._gaxModule.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.retail.v2alpha.ImportCompletionDataResponse, protos.google.cloud.retail.v2alpha.ImportMetadata>;
  }
/**
