...
describe('v2alpha.UserEventServiceClient', () => {
    ...
    describe('writeUserEvent', () => {
        it('invokes writeUserEvent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('WriteUserEventRequest', ['parent']);
    ...
    describe('collectUserEvent', () => {
        it('invokes collectUserEvent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CollectUserEventRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('purgeUserEvents', () => {
        it('invokes purgeUserEvents without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('PurgeUserEventsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('importUserEvents', () => {
        it('invokes importUserEvents without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ImportUserEventsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('rejoinUserEvents', () => {
        it('invokes rejoinUserEvents without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('RejoinUserEventsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
