...
describe('v2alpha.UserEventServiceClient', () => {
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = usereventserviceModule.v2alpha.UserEventServiceClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = usereventserviceModule.v2alpha.UserEventServiceClient.apiEndpoint;
            assert(apiEndpoint);
        });
    ...
    describe('writeUserEvent', () => {
        it('invokes writeUserEvent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.WriteUserEventRequest', ['parent']);
        ...
        it('invokes writeUserEvent without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.writeUserEvent(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2alpha.IUserEvent|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('collectUserEvent', () => {
        it('invokes collectUserEvent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.CollectUserEventRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('purgeUserEvents', () => {
        it('invokes purgeUserEvents without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.PurgeUserEventsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes purgeUserEvents without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.purgeUserEvents(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.retail.v2alpha.IPurgeUserEventsResponse, protos.google.cloud.retail.v2alpha.IPurgeMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.retail.v2alpha.IPurgeUserEventsResponse, protos.google.cloud.retail.v2alpha.IPurgeMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.purgeUserEvents as SinonStub)
                .getCall(0).args[0];
    ...
    describe('importUserEvents', () => {
        it('invokes importUserEvents without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.ImportUserEventsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes importUserEvents without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.importUserEvents(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.retail.v2alpha.IImportUserEventsResponse, protos.google.cloud.retail.v2alpha.IImportMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.retail.v2alpha.IImportUserEventsResponse, protos.google.cloud.retail.v2alpha.IImportMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.importUserEvents as SinonStub)
                .getCall(0).args[0];
    ...
    describe('rejoinUserEvents', () => {
        it('invokes rejoinUserEvents without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2alpha.RejoinUserEventsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes rejoinUserEvents without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.rejoinUserEvents(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.retail.v2alpha.IRejoinUserEventsResponse, protos.google.cloud.retail.v2alpha.IRejoinUserEventsMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.retail.v2alpha.IRejoinUserEventsResponse, protos.google.cloud.retail.v2alpha.IRejoinUserEventsMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.rejoinUserEvents as SinonStub)
                .getCall(0).args[0];
