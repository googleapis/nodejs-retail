...
describe('v2alpha.ModelServiceClient', () => {
    ...
    describe('pauseModel', () => {
        it('invokes pauseModel without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2alpha.PauseModelRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.retail.v2alpha.Model());
    ...
    describe('resumeModel', () => {
        it('invokes resumeModel without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2alpha.ResumeModelRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('deleteModel', () => {
        it('invokes deleteModel without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2alpha.DeleteModelRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('updateModel', () => {
        it('invokes updateModel without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2alpha.UpdateModelRequest());
            request.model = {};
            request.model.name = '';
    ...
    describe('createModel', () => {
        it('invokes createModel without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2alpha.CreateModelRequest());
            request.parent = '';
