...
describe('v2alpha.ServingConfigServiceClient', () => {
    ...
    describe('createServingConfig', () => {
        it('invokes createServingConfig without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.retail.v2alpha.ServingConfig());
    ...
    describe('deleteServingConfig', () => {
        it('invokes deleteServingConfig without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2alpha.DeleteServingConfigRequest());
            request.name = '';
    ...
    describe('updateServingConfig', () => {
        it('invokes updateServingConfig without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2alpha.UpdateServingConfigRequest());
    ...
    describe('getServingConfig', () => {
        it('invokes getServingConfig without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2alpha.GetServingConfigRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('addControl', () => {
        it('invokes addControl without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2alpha.AddControlRequest());
            request.servingConfig = '';
    ...
    describe('removeControl', () => {
        it('invokes removeControl without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2alpha.RemoveControlRequest());
            request.servingConfig = '';
            const expectedHeaderRequestParams = "serving_config=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listServingConfigs', () => {
        it('invokes listServingConfigs without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2alpha.ListServingConfigsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
