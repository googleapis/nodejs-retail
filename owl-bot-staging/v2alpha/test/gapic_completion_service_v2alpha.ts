...
describe('v2alpha.CompletionServiceClient', () => {
    ...
    describe('completeQuery', () => {
        it('invokes completeQuery without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2alpha.CompleteQueryRequest());
            request.catalog = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.retail.v2alpha.CompleteQueryResponse());
    ...
    describe('importCompletionData', () => {
        it('invokes importCompletionData without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2alpha.ImportCompletionDataRequest());
            request.parent = '';
