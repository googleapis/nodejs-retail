...
describe('v2alpha.ControlServiceClient', () => {
    ...
    describe('createControl', () => {
        it('invokes createControl without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateControlRequest', ['parent']);
    ...
    describe('deleteControl', () => {
        it('invokes deleteControl without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteControlRequest', ['name']);
    ...
    describe('updateControl', () => {
        it('invokes updateControl without error', async () => {
            ...
            request.control ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateControlRequest', ['control', 'name']);
    ...
    describe('getControl', () => {
        it('invokes getControl without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetControlRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.retail.v2alpha.Control()
    ...
    describe('listControls', () => {
        it('invokes listControls without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListControlsRequest', ['parent']);
            request.parent = defaultValue1;
