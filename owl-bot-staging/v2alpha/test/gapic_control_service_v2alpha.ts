...
describe('v2alpha.ControlServiceClient', () => {
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = controlserviceModule.v2alpha.ControlServiceClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = controlserviceModule.v2alpha.ControlServiceClient.apiEndpoint;
            assert(apiEndpoint);
        });

        it('has port', () => {
            const port = controlserviceModule.v2alpha.ControlServiceClient.port;
            assert(port);
    ...
    describe('createControl', () => {
        it('invokes createControl without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2alpha.CreateControlRequest());
            request.parent = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.retail.v2alpha.Control());
            ...
            assert((client.innerApiCalls.createControl as SinonStub)
        ...
        it('invokes createControl without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createControl(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2alpha.IControl|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('deleteControl', () => {
        it('invokes deleteControl without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2alpha.DeleteControlRequest());
            request.name = '';
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteControl as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('updateControl', () => {
        it('invokes updateControl without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2alpha.UpdateControlRequest());
            request.control = {};
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateControl as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('getControl', () => {
        it('invokes getControl without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2alpha.GetControlRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getControl as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listControls', () => {
        it('invokes listControls without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listControls as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes listControlsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.retail.v2alpha.Control[] = [];
                stream.on('data', (response: protos.google.cloud.retail.v2alpha.Control) => {
        ...
        it('uses async iteration with listControls without error', async () => {
            ...
            const responses: protos.google.cloud.retail.v2alpha.IControl[] = [];
