 ...
 *   {@link google.cloud.retail.v2.Catalog|Catalog} to update. If not set, will only
 *   update the
 *   {@link google.cloud.retail.v2.Catalog.product_level_config|Catalog.product_level_config}
