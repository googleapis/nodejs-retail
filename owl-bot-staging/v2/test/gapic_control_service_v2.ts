...
describe('v2.ControlServiceClient', () => {
    ...
    describe('createControl', () => {
        it('invokes createControl without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.retail.v2.Control());
    ...
    describe('deleteControl', () => {
        it('invokes deleteControl without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2.DeleteControlRequest());
            request.name = '';
    ...
    describe('updateControl', () => {
        it('invokes updateControl without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2.UpdateControlRequest());
            request.control = {};
    ...
    describe('getControl', () => {
        it('invokes getControl without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2.GetControlRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
