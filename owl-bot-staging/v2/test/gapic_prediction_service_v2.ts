...
describe('v2.PredictionServiceClient', () => {
    ...
    describe('predict', () => {
        it('invokes predict without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2.PredictRequest());
            request.placement = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.retail.v2.PredictResponse());
