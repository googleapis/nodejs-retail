...
describe('v2.ProductServiceClient', () => {
    ...
    describe('setInventory', () => {
        it('invokes setInventory without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2.SetInventoryRequest());
            request.inventory = {};
    ...
    describe('addFulfillmentPlaces', () => {
        it('invokes addFulfillmentPlaces without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2.AddFulfillmentPlacesRequest());
            request.product = '';
    ...
    describe('removeFulfillmentPlaces', () => {
        it('invokes removeFulfillmentPlaces without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2.RemoveFulfillmentPlacesRequest());
            request.product = '';
            const expectedHeaderRequestParams = "product=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('addLocalInventories', () => {
        it('invokes addLocalInventories without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2.AddLocalInventoriesRequest());
            request.product = '';
            const expectedHeaderRequestParams = "product=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('removeLocalInventories', () => {
        it('invokes removeLocalInventories without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2.RemoveLocalInventoriesRequest());
            request.product = '';
            const expectedHeaderRequestParams = "product=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listProducts', () => {
        it('invokes listProducts without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2.ListProductsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
