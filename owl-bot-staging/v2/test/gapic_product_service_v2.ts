...
describe('v2.ProductServiceClient', () => {
    ...
    describe('createProduct', () => {
        it('invokes createProduct without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.CreateProductRequest', ['parent']);
    ...
    describe('getProduct', () => {
        it('invokes getProduct without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.GetProductRequest', ['name']);
    ...
    describe('updateProduct', () => {
        it('invokes updateProduct without error', async () => {
            ...
            request.product ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.UpdateProductRequest', ['product', 'name']);
    ...
    describe('deleteProduct', () => {
        it('invokes deleteProduct without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.DeleteProductRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('importProducts', () => {
        it('invokes importProducts without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.ImportProductsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('setInventory', () => {
        it('invokes setInventory without error', async () => {
            ...
            request.inventory ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.SetInventoryRequest', ['inventory', 'name']);
        ...
        it('invokes setInventory without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.setInventory(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.retail.v2.ISetInventoryResponse, protos.google.cloud.retail.v2.ISetInventoryMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.retail.v2.ISetInventoryResponse, protos.google.cloud.retail.v2.ISetInventoryMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.setInventory as SinonStub)
                .getCall(0).args[0];
    ...
    describe('addFulfillmentPlaces', () => {
        it('invokes addFulfillmentPlaces without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.AddFulfillmentPlacesRequest', ['product']);
        ...
        it('invokes addFulfillmentPlaces without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.addFulfillmentPlaces(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.retail.v2.IAddFulfillmentPlacesResponse, protos.google.cloud.retail.v2.IAddFulfillmentPlacesMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.retail.v2.IAddFulfillmentPlacesResponse, protos.google.cloud.retail.v2.IAddFulfillmentPlacesMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.addFulfillmentPlaces as SinonStub)
                .getCall(0).args[0];
    ...
    describe('removeFulfillmentPlaces', () => {
        it('invokes removeFulfillmentPlaces without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.RemoveFulfillmentPlacesRequest', ['product']);
            request.product = defaultValue1;
            const expectedHeaderRequestParams = `product=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes removeFulfillmentPlaces without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.removeFulfillmentPlaces(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.retail.v2.IRemoveFulfillmentPlacesResponse, protos.google.cloud.retail.v2.IRemoveFulfillmentPlacesMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.retail.v2.IRemoveFulfillmentPlacesResponse, protos.google.cloud.retail.v2.IRemoveFulfillmentPlacesMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.removeFulfillmentPlaces as SinonStub)
                .getCall(0).args[0];
    ...
    describe('addLocalInventories', () => {
        it('invokes addLocalInventories without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.AddLocalInventoriesRequest', ['product']);
            request.product = defaultValue1;
            const expectedHeaderRequestParams = `product=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes addLocalInventories without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.addLocalInventories(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.retail.v2.IAddLocalInventoriesResponse, protos.google.cloud.retail.v2.IAddLocalInventoriesMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.retail.v2.IAddLocalInventoriesResponse, protos.google.cloud.retail.v2.IAddLocalInventoriesMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.addLocalInventories as SinonStub)
                .getCall(0).args[0];
    ...
    describe('removeLocalInventories', () => {
        it('invokes removeLocalInventories without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.RemoveLocalInventoriesRequest', ['product']);
            request.product = defaultValue1;
            const expectedHeaderRequestParams = `product=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes removeLocalInventories without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.removeLocalInventories(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.retail.v2.IRemoveLocalInventoriesResponse, protos.google.cloud.retail.v2.IRemoveLocalInventoriesMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.retail.v2.IRemoveLocalInventoriesResponse, protos.google.cloud.retail.v2.IRemoveLocalInventoriesMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.removeLocalInventories as SinonStub)
                .getCall(0).args[0];
    ...
    describe('listProducts', () => {
        it('invokes listProducts without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.ListProductsRequest', ['parent']);
            request.parent = defaultValue1;
