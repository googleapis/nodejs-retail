...
describe('v2.ProductServiceClient', () => {
    ...
    describe('createProduct', () => {
        it('invokes createProduct without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateProductRequest', ['parent']);
    ...
    describe('getProduct', () => {
        it('invokes getProduct without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetProductRequest', ['name']);
    ...
    describe('updateProduct', () => {
        it('invokes updateProduct without error', async () => {
            ...
            request.product ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateProductRequest', ['product', 'name']);
    ...
    describe('deleteProduct', () => {
        it('invokes deleteProduct without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteProductRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('importProducts', () => {
        it('invokes importProducts without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ImportProductsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('setInventory', () => {
        it('invokes setInventory without error', async () => {
            ...
            request.inventory ??= {};
            const defaultValue1 =
              getTypeDefaultValue('SetInventoryRequest', ['inventory', 'name']);
    ...
    describe('addFulfillmentPlaces', () => {
        it('invokes addFulfillmentPlaces without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('AddFulfillmentPlacesRequest', ['product']);
    ...
    describe('removeFulfillmentPlaces', () => {
        it('invokes removeFulfillmentPlaces without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('RemoveFulfillmentPlacesRequest', ['product']);
            request.product = defaultValue1;
            const expectedHeaderRequestParams = `product=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('addLocalInventories', () => {
        it('invokes addLocalInventories without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('AddLocalInventoriesRequest', ['product']);
            request.product = defaultValue1;
            const expectedHeaderRequestParams = `product=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('removeLocalInventories', () => {
        it('invokes removeLocalInventories without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('RemoveLocalInventoriesRequest', ['product']);
            request.product = defaultValue1;
            const expectedHeaderRequestParams = `product=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listProducts', () => {
        it('invokes listProducts without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListProductsRequest', ['parent']);
            request.parent = defaultValue1;
