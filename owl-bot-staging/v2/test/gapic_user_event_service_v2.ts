...
describe('v2.UserEventServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = usereventserviceModule.v2.UserEventServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = usereventserviceModule.v2.UserEventServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });
    ...
    describe('writeUserEvent', () => {
        it('invokes writeUserEvent without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2.WriteUserEventRequest());
            request.parent = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.retail.v2.UserEvent());
        ...
        it('invokes writeUserEvent without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.writeUserEvent(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2.IUserEvent|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('collectUserEvent', () => {
        it('invokes collectUserEvent without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2.CollectUserEventRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('purgeUserEvents', () => {
        it('invokes purgeUserEvents without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2.PurgeUserEventsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
        ...
        it('invokes purgeUserEvents without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.purgeUserEvents(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.retail.v2.IPurgeUserEventsResponse, protos.google.cloud.retail.v2.IPurgeMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.retail.v2.IPurgeUserEventsResponse, protos.google.cloud.retail.v2.IPurgeMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.purgeUserEvents as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
    ...
    describe('importUserEvents', () => {
        it('invokes importUserEvents without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2.ImportUserEventsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
        ...
        it('invokes importUserEvents without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.importUserEvents(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.retail.v2.IImportUserEventsResponse, protos.google.cloud.retail.v2.IImportMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.retail.v2.IImportUserEventsResponse, protos.google.cloud.retail.v2.IImportMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.importUserEvents as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
    ...
    describe('rejoinUserEvents', () => {
        it('invokes rejoinUserEvents without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2.RejoinUserEventsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.rejoinUserEvents as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes rejoinUserEvents without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.rejoinUserEvents(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.retail.v2.IRejoinUserEventsResponse, protos.google.cloud.retail.v2.IRejoinUserEventsMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.retail.v2.IRejoinUserEventsResponse, protos.google.cloud.retail.v2.IRejoinUserEventsMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.rejoinUserEvents as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
