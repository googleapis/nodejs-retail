...
describe('v2.CatalogServiceClient', () => {
    ...
    describe('updateCatalog', () => {
        it('invokes updateCatalog without error', async () => {
            ...
            request.catalog ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.UpdateCatalogRequest', ['catalog', 'name']);
    ...
    describe('setDefaultBranch', () => {
        it('invokes setDefaultBranch without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.SetDefaultBranchRequest', ['catalog']);
    ...
    describe('getDefaultBranch', () => {
        it('invokes getDefaultBranch without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.GetDefaultBranchRequest', ['catalog']);
            request.catalog = defaultValue1;
            const expectedHeaderRequestParams = `catalog=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getCompletionConfig', () => {
        it('invokes getCompletionConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.GetCompletionConfigRequest', ['name']);
    ...
    describe('updateCompletionConfig', () => {
        it('invokes updateCompletionConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.UpdateCompletionConfigRequest', ['completionConfig', 'name']);
    ...
    describe('getAttributesConfig', () => {
        it('invokes getAttributesConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.GetAttributesConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('updateAttributesConfig', () => {
        it('invokes updateAttributesConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.UpdateAttributesConfigRequest', ['attributesConfig', 'name']);
    ...
    describe('addCatalogAttribute', () => {
        it('invokes addCatalogAttribute without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.AddCatalogAttributeRequest', ['attributesConfig']);
    ...
    describe('removeCatalogAttribute', () => {
        it('invokes removeCatalogAttribute without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.RemoveCatalogAttributeRequest', ['attributesConfig']);
            request.attributesConfig = defaultValue1;
            const expectedHeaderRequestParams = `attributes_config=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.retail.v2.AttributesConfig()
    ...
    describe('replaceCatalogAttribute', () => {
        it('invokes replaceCatalogAttribute without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.ReplaceCatalogAttributeRequest', ['attributesConfig']);
            request.attributesConfig = defaultValue1;
            const expectedHeaderRequestParams = `attributes_config=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.retail.v2.AttributesConfig()
    ...
    describe('listCatalogs', () => {
        it('invokes listCatalogs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.retail.v2.ListCatalogsRequest', ['parent']);
