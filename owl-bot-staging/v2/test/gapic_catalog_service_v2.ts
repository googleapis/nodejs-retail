...
describe('v2.CatalogServiceClient', () => {
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = catalogserviceModule.v2.CatalogServiceClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = catalogserviceModule.v2.CatalogServiceClient.apiEndpoint;
            assert(apiEndpoint);
        });
    ...
    describe('updateCatalog', () => {
        it('invokes updateCatalog without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.retail.v2.Catalog());
        ...
        it('invokes updateCatalog without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.updateCatalog(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2.ICatalog|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getDefaultBranch', () => {
        it('invokes getDefaultBranch without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2.GetDefaultBranchRequest());
            request.catalog = '';
            const expectedHeaderRequestParams = "catalog=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.retail.v2.GetDefaultBranchResponse());
        ...
        it('invokes getDefaultBranch without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getDefaultBranch(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2.IGetDefaultBranchResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getCompletionConfig', () => {
        it('invokes getCompletionConfig without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2.GetCompletionConfigRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.retail.v2.CompletionConfig());
        ...
        it('invokes getCompletionConfig without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getCompletionConfig(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2.ICompletionConfig|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateCompletionConfig', () => {
        it('invokes updateCompletionConfig without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2.UpdateCompletionConfigRequest());
    ...
    describe('getAttributesConfig', () => {
        it('invokes getAttributesConfig without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2.GetAttributesConfigRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.retail.v2.AttributesConfig());
        ...
        it('invokes getAttributesConfig without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAttributesConfig(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.retail.v2.IAttributesConfig|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateAttributesConfig', () => {
        it('invokes updateAttributesConfig without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2.UpdateAttributesConfigRequest());
    ...
    describe('addCatalogAttribute', () => {
        it('invokes addCatalogAttribute without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2.AddCatalogAttributeRequest());
            request.attributesConfig = '';
    ...
    describe('removeCatalogAttribute', () => {
        it('invokes removeCatalogAttribute without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2.RemoveCatalogAttributeRequest());
            request.attributesConfig = '';
            const expectedHeaderRequestParams = "attributes_config=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('replaceCatalogAttribute', () => {
        it('invokes replaceCatalogAttribute without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.retail.v2.ReplaceCatalogAttributeRequest());
            request.attributesConfig = '';
            const expectedHeaderRequestParams = "attributes_config=";
            const expectedOptions = {
                otherArgs: {
